...
/**
 * Helper functions
 * These implicit conversions are loaded with import Hooks._
 * They allow hooks with a tuple for the `extra` parameter to be used as if they were varargs.
 * These conversion should *not* be loaded for normal contexts.
 */
